...
public class DoctorServiceImpl implements DoctorService {
    ...
    public DoctorProfileDto registerDoctor(DoctorProfileDto dto, String password) {
        ...
        // 2. Create DoctorProfile (status = PENDING_APPROVAL by default)
        ...
        // 3. Create admin notification (inbox item)
        String specs = savedProfile.getSpecialization() != null ? String.join(", ", savedProfile.getSpecialization()) : "";
        String message = String.format(
                "New doctor registered and awaiting approval. " +
                "Name: %s %s | Email: %s | Specialization: %s | Department: %s",
        ...
        // 4. Send email to PROVIDER admin (async)
