    ...
    <>
      <Card className="border-slate-200 bg-white shadow-sm px-5 py-4 w-full flex flex-col gap-3.5">
        <CardDescription className="text-sm font-mono flex items-center justify-between pb-1 text-slate-400">
          ...
          <Link
            href="/"
            className="text-indigo-600 hover:text-indigo-700 font-sans font-medium text-xs"
          >
            Full Schedule
          </Link>
        </CardDescription>
...
// export function SlotAvailableSkeleton() {
//   return (
//     <>
//       <Card className="border-slate-200 bg-white shadow-sm px-5 py-4 w-full flex flex-col gap-3.5">
//         <CardDescription className="text-sm font-mono flex items-center justify-between pb-1 text-slate-400">
...
function NumberOfSlotsSkeleton() {
  return (
    <div className="flex flex-col gap-1.5 items-center font-sans">
